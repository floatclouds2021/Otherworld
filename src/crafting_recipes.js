...
(()=>{
    forging_recipes.components["剑刃"] = new ComponentRecipe({
        name: "剑刃",
        materials: [
			{material_id: "木头", count: 2, result_id: "木剑刃"}, 
    ...
    forging_recipes.components["剑柄"] = new ComponentRecipe({
        name: "剑柄",
        materials: [
			{material_id: "稻草", count: 2, result_id: "稻草剑柄"}, 
...
(()=>{
	...
	crafting_recipes.equipment["弓"] = new EquipmentRecipe({
        name: "弓",
        components: ["bent body", "bowstring"],
        item_type: "Weapon",
    });
...
/*    alchemy_recipes.items["粘合织料"] = new ItemRecipe({
    ...
    alchemy_recipes.items["润灵铜骨"] = new ItemRecipe({
     ...
     alchemy_recipes.items["提炼宝石"] = new ItemRecipe({
        ...
        result: {result_id: "一级妖兽内丹", count: 1},
        success_chance: [0.2,1],
        recipe_level: [0,6],
        recipe_skill: "Alchemy",
    });
    ...
    alchemy_recipes.items["精炼宝石 I"] = new ItemRecipe({
        name: "精炼宝石 I",
        recipe_type: "material",
        materials: [{material_id: "一级妖兽内丹", count: 5},{material_id: "魔力碎晶", count: 2}], 
